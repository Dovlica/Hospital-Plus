...
<div class="super_container">
	...
	<div class="home">
		<div class="background_image" style="background-image:url(homepage/images/index_hero.jpg)"></div>
		...
		<div class="container">
			<div class="row row-eq-height">
				...
				<div class="col-lg-4 info_box_col">
					<div class="info_box">
						<div class="info_image"><img src="homepage/images/info_1.jpg" alt=""></div>
				...
				<div class="col-lg-4 info_box_col">
					<div class="info_box">
						<div class="info_image"><img src="homepage/images/info_2.jpg" alt=""></div>
						<div class="info_content">
	...
	<div class="cta">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="homepage/images/cta_1.jpg" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
				<div class="col">
		...
		<div class="container">
			...
			<div class="row icon_boxes_row">
				...
				<div class="col-xl-4 col-lg-6">
					<div class="icon_box">
						<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
							<div class="icon_box_icon"><img src="homepage/images/icon_1.svg" alt=""></div>
				...
				<div class="col-xl-4 col-lg-6">
					<div class="icon_box">
						<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
							<div class="icon_box_icon"><img src="homepage/images/icon_2.svg" alt=""></div>
				...
				<div class="col-xl-4 col-lg-6">
					<div class="icon_box">
						<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
							<div class="icon_box_icon"><img src="homepage/images/icon_3.svg" alt=""></div>
				...
				<div class="col-xl-4 col-lg-6">
					<div class="icon_box">
						<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
							<div class="icon_box_icon"><img src="homepage/images/icon_4.svg" alt=""></div>
				...
				<div class="col-xl-4 col-lg-6">
					<div class="icon_box">
						<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
							<div class="icon_box_icon"><img src="homepage/images/icon_5.svg" alt=""></div>
				...
				<div class="col-xl-4 col-lg-6">
					<div class="icon_box">
						<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
							<div class="icon_box_icon"><img src="homepage/images/icon_6.svg" alt=""></div>
						...
						<div class="dept_slider_container">
							...
							<div class="owl-carousel owl-theme dept_slider">
								...
								<div class="owl-item dept_item">
									<div class="dept_image"><img src="homepage/images/dept_1.jpg" alt=""></div>
								...
								<!-- Slide -->
								<div class="owl-item dept_item">
									<div class="dept_image"><img src="homepage/images/dept_2.jpg" alt=""></div>
									<div class="dept_content">
								...
								<!-- Slide -->
								<div class="owl-item dept_item">
									<div class="dept_image"><img src="homepage/images/dept_3.jpg" alt=""></div>
									<div class="dept_content">
								...
								<!-- Slide -->
								<div class="owl-item dept_item">
									<div class="dept_image"><img src="homepage/images/dept_4.jpg" alt=""></div>
									<div class="dept_content">
					...
					<div class="news">
						...
						<div class="news_container">
							...
							<div class="latest d-flex flex-row align-items-start justify-content-start">
								<div><div class="latest_image"><img src="homepage/images/latest_1.jpg" alt=""></div></div>
							...
							<!-- Latest News Post -->
							<div class="latest d-flex flex-row align-items-start justify-content-start">
								<div><div class="latest_image"><img src="homepage/images/latest_2.jpg" alt=""></div></div>
								<div class="latest_content">
							...
							<!-- Latest News Post -->
							<div class="latest d-flex flex-row align-items-start justify-content-start">
								<div><div class="latest_image"><img src="homepage/images/latest_3.jpg" alt=""></div></div>
								<div class="latest_content">
	...
	<footer class="footer">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="homepage/images/footer.jpg" data-speed="0.8"></div>
